...
/* Prices intentionally left blank — admin will fill these in later via Product Master. */
const DEFAULT_PRODUCTS = [
    {
        ...
        tiers: [
            { label: 'Price per Packet', qty: 1, price: null, mrp: null }
        ]
    },
    {
        id: 'xl15',
    ...
    },
    {
        ...
        meta: 'Outright Purchase',
        tiers: [
            { label: 'Price per Unit', qty: 1, price: null, mrp: null }
        ]
    },
    {
        id: 'vendingrent',
        name: 'Vending Machine Rent',
        meta: 'Rental (per month)',
        tiers: [
            { label: 'Price per Month', qty: 1, price: null, mrp: null }
        ]
    }
];
...
function renderPending() {
    const list = getEnquiries().filter(e => e.quoted !== true);
